  ...
  render() {
    return (
      <Article title='AutoSampler for Max4Live' disqusId='AutoSampler' url='https://karlhiner.com/music_generation/auto_sampler'>
        ...
        <p>AutoSampler doesn't hit this audacious target by any means, but it tackles one such specific problem, "I want to find samples in my library that match this note or melody and work well together, and I want to play them live". It's easy in most DAWs to find a sample and pitch it up and down with a keyboard, but if you want to find samples that <em>already</em> match the pitches of a melody and preserve the original sound quality entirely, there's no way to do that other than to start digging.</p>

        <p>As it is, this instrument can find inspiring combinations of samples that sound great together. You can trigger them with a keyboard or arpeggiator or MIDI effect, loop them and rearrange them. But while I think it is fun and unique as an instrument on its own, my real hope is that it helps introduce you to more of the raw sounds in your music collection (or maybe podcast library, or books on tape...) in a musical context, so that you can quickly find inspiration when you're creating a great track.</p>
