...
export default (
  <div>
    ...
    <Paragraph>Here are the full instructions for setting up, training and generating the above samples:</Paragraph>
...
$ python generate.py --wav_out_path=generated-bad-plus-give-with-silence-64000.wav --samples 64000 logdir/train/2019-07-07T15-54-50/model.ckpt-99950`}
    ...
    <Paragraph>The short result seemed pretty similar:</Paragraph>
