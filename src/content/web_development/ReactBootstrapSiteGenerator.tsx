...
export default (
  <div>
    ...
    <p>
      ...
      <ul>
        ...
        <li>Make adding new content as quick as possible, while still allowing content to be arbitrarily complex</li>
        <li>
          Separate form from content - writing a new entry should only require touching one file for the usual case
        </li>
        <li>
          Automate the boring stuff - nested nav generation, site and page metadata for search engine crawlers, static
          HTML generation, browser tab titles
        </li>
        <li>Automatic social media stuff per-post</li>
        <li>
          Straightforward deployment: run <code>npm build</code> and <code>scp</code> the build directory to my hosting
          service's <code>public_html</code> directory
        </li>
        <li>
          A modern stack with all the trimmings, including a precommit hook for automatic style-enforcement and sass
  ...
  $(document).ready(function() {
    ...
    <p>
      ...
      <ul>
        <li>
          I still had a ton of duplication in the form of html <code>head</code> tags and other random junk.
        </li>
        <li>
          Making structural changes to each post still required changing HTML everywhere, and there was no easy way
          around this.
        </li>
        <li>
          Managing js dependencies and versions and running a local server manually was a pain and felt really outdated.
        </li>
        <li>I was really missing object-oriented patterns like inheritance and composition.</li>
      </ul>
    ...
    <code>react-script</code> to be used directly with <code>create-react-app</code>. It's inteded more as a starting
    point than a framework. In the simplest cases, if your needs are similar to mine, you can get away with only
    modifying a couple files (<code>entries.js</code> and <code>config.js</code>
    ), but more likely you'll want to modify the site-generation code in <code>src/app</code> to suit your own needs.
