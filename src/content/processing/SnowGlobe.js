...
export default (
  <div>
    <h2 className="lead">
      Some fun with edge detection. This very simple effect, when used on images
      like cityscapes, looks like a blizzard.
      <br />
    </h2>
    <p>
      This uses the Canny edge detection method. Canny is much more verbose and
      complex than some others like the Sobel method, but has better results,
      especially on noisy images, and performs at about the same speed.
    </p>
    <ul>
    ...
    <small>
      This implementation of Canny Edge Detection is stripped down and adapted
