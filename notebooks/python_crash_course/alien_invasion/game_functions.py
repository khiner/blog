...
def check_keydown_events(event, aliens, ship, bullets, sb, screen, settings, stats):
...
def check_events(aliens, ship, bullets, sb, play_button, screen, settings, stats):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(mouse_x, mouse_y, aliens, ship, bullets, sb, play_button, screen, settings, stats)

def check_play_button(mouse_x, mouse_y, aliens, ship, bullets, sb, play_button, screen, settings, stats):
    """Start a new game when the player clicks Play."""
    button_clicked = play_button.rect.collidepoint(mouse_x, mouse_y)
    if button_clicked:
        start_game(aliens, ship, bullets, sb, screen, settings, stats)

def start_game(aliens, ship, bullets, sb, screen, settings, stats):
...
def update_screen(ship, aliens, bullets, screen, play_button, sb, settings, stats):
...
def update_bullets(bullets, ship, aliens, sb, screen, settings, stats):
    """Update position of bullets and get rid of old bullets."""
    bullets.update()
    delete_stale_bullets(bullets)

    check_bullet_alien_collisions(bullets, ship, aliens, sb, screen, settings, stats)

def check_bullet_alien_collisions(bullets, ship, aliens, sb, screen, settings, stats):
    ...
    if collisions:
        ...
        for aliens in collisions.values():
            total_points += settings.alien_points * len(aliens)
...
def update_aliens(aliens, ship, bullets, sb, screen, settings, stats):
    """
    ...
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hit(ship, aliens, bullets, sb, screen, settings, stats)
...
def ship_hit(ship, aliens, bullets, sb, screen, settings, stats):
